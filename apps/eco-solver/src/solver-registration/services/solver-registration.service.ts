...
import { APIConfig } from '../../common/rest-api/interfaces/api-config.interface'
...
import { QuotesConfig, ServerConfig, Solver, SolverRegistrationConfig } from '@libs/solver-config'
