import { WalletClient, Hex, Transport, Chain, Account, RpcSchema, Prettify, WalletRpcSchema, PublicActions } from 'viem';
import { DeployFactoryArgs } from './kernel';
export type ExecuteSmartWalletArg = {
    to: Hex;
    data?: Hex;
    value?: bigint;
};
