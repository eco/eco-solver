 ...
 */
export declare const ANALYTICS_SERVICE = "ANALYTICS_SERVICE";
/**
...
export declare class AnalyticsModule {
     ...
     * }))
     */
    static withConfig(configFactory: (() => AnalyticsConfig) | (() => Promise<AnalyticsConfig>)): DynamicModule;
    /**
     ...
     */
    private static createPostHogProvider;
    /**
     ...
     */
    private static createEcoAnalyticsProvider;
}
