...
export type IntentProcessorJob = ExecuteWithdrawsJob | CheckWithdrawsCronJob | CheckSendBatchJob | ExecuteSendBatchJob;
export declare abstract class IntentProcessorJobManager<Job extends IntentProcessorJob = IntentProcessorJob> extends BaseJobManager<Job> {
}
