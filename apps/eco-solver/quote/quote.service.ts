...
import { validationsSucceeded, TxValidationFn } from '@/intent/types'
...
import { GasEstimationsConfig, QuotesConfig } from '@eco/infrastructure-config'
import { QuoteDataEntryDTO } from './dto/quote-data-entry.dto'
import { QuoteDataDTO } from '@eco/shared-dto'
