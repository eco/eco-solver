...
import { MultichainPublicClientService, EcoConfigService, KernelAccountClientService } from '@libs/integrations'
import { ChainSyncDomainService, CreateIntentService } from '@libs/domain'
import { IntentFundedLog, EcoLogMessage, IntentSource, IntentSourceAbi, IntentSourceModel } from '@libs/shared'
import { WatchIntentFundedService } from '../listeners/intent/intent-funded-events/services/watch-intent-funded.service'
import { IntentFundedEventModel } from '../listeners/intent/intent-funded-events/schemas/intent-funded-events.schema'
...
export class IntentFundedChainSyncService extends ChainSyncService {
  ...
  constructor(
    ...
    readonly chainSyncDomain: ChainSyncDomainService,
