...
import { EcoLogMessage, IntentSource, IntentSourceModel } from '@libs/shared'
import { WatchEventService } from '../listeners/intent/watch-event.service'
...
export abstract class ChainSyncService implements OnApplicationBootstrap {
  constructor(
    ...
    protected multichainClientService: MultichainPublicClientService,
    protected watchIntentService: WatchEventService<IntentSource>,
    protected chainSyncDomain: ChainSyncDomainService,
