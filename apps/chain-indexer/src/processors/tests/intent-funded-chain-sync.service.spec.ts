...
import { CreateIntentService } from '@libs/domain'
import { IntentSourceModel, IntentFundedEventModel } from '@libs/shared'
...
describe.skip('IntentFundedChainSyncService', () => {
  ...
  beforeEach(async () => {
    const chainMod: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: WatchIntentFundedService, useValue: createMock<WatchIntentFundedService>() },
    ...
    chainSyncService = chainMod.get(IntentFundedChainSyncService)
    accountService = chainMod.get(KernelAccountClientService)
    watchIntentService = chainMod.get(WatchIntentFundedService)
  ...
  describe('on syncTxsPerSource', () => {
    ...
    it('should log when no transactions exist since last db record', async () => {
      chainSyncService['getLastRecordedTx'] = jest.fn().mockResolvedValueOnce([model])
    ...
    it('should sdd jobs to the queue', async () => {
