...
import { Injectable, Logger, OnModuleInit, ModuleRef } from '@nestjs/common'
import { Hex, encodeFunctionData, erc20Abi, parseGwei, formatEther } from 'viem'
import dayjs from 'dayjs'
import { QuoteRepository } from './quote.repository'
import { FeeService, ValidationService, FulfillmentEstimateService } from '@libs/domain'
import { EcoConfigService, EcoAnalyticsService } from '@libs/integrations'
import { EcoResponse, EcoError, EcoLogMessage, serialize, Mathb } from '@libs/shared'
import { QuoteIntentModel } from './schemas/quote-intent.schema'
import { IntentInitiationService } from '../application/services/intent-initiation.service'
import {
  QuoteIntentDataDTO,
  QuoteDataDTO,
  QuoteDataEntryDTO,
  QuoteRewardTokensDTO,
  QuoteCallDataDTO,
