...
} from '@app/intent/validation.sevice'
jest.mock('../utils', () => {
  return {
...
describe('ValidationService', () => {
  ...
  describe('on individual validation cases', () => {
    ...
    describe('on supportedNative', () => {
      ...
      beforeEach(() => {
        mockIsNativeIntent = jest.spyOn(require('../utils'), 'isNativeIntent')
        mockEquivalentNativeGas = jest.spyOn(require('../utils'), 'equivalentNativeGas')
        mockIsNativeETH = jest.spyOn(require('../utils'), 'isNativeETH')
      })
    ...
    describe('on supportedTargets', () => {
      ...
      beforeEach(() => {
        mockGetFunctionTargets = jest.spyOn(require('../utils'), 'getFunctionTargets')
      })
