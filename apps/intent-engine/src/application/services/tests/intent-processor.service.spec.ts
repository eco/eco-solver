...
describe('IntentProcessorService', () => {
  ...
  beforeEach(async () => {
    ...
    const hyperlaneModule = jest.requireMock('../../utils/hyperlane')
    ...
    const multicallModule = jest.requireMock('../../utils/multicall')
    ...
    jest
      .spyOn(require('integrations/aws/utils'), 'getChainConfig')
