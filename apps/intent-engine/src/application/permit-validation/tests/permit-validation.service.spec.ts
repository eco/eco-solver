jest.mock('../permit-validator', () => {
  // Import the real module first
  const actual = jest.requireActual('../permit-validator')
...
jest.mock('../permit2-validator', () => {
  // Import the real module first
  const actual = jest.requireActual('../permit2-validator')
