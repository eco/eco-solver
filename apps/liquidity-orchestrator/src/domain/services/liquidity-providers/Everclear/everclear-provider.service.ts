import { Injectable, OnModuleInit, Inject, CACHE_MANAGER, Logger } from '@nestjs/common'
import { InjectQueue } from '@nestjs/bull'
import { Cache } from 'cache-manager'
import { Hex, formatUnits, parseUnits, erc20Abi, TransactionRequest } from 'viem'
import { EcoConfigService, EverclearConfig } from '@libs/integrations/aws'
...
import { TokenData, RebalanceQuote, EverclearStrategyContext } from '../../types/types'
import {
