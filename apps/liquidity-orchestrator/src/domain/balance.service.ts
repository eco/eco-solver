import { Injectable, OnApplicationBootstrap, Inject, CACHE_MANAGER, Logger } from '@nestjs/common'
import { Cache } from 'cache-manager'
import { Hex, MulticallParameters, MulticallReturnType, erc20Abi } from 'viem'
...
import { Cacheable } from '@libs/shared/utils'
import { EcoLogMessage } from '@libs/shared/logging'
import { EcoError } from '@libs/shared/errors'
import { TokenConfig, TokenBalance } from '@libs/contracts'
import { ViemEventLog } from '@libs/shared/types'
import { decodeTransferLog, getDestinationNetworkAddressKey, isSupportedTokenType } from '@libs/shared/utils'
