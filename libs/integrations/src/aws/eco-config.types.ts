...
import type { Redis, ClusterNode } from 'ioredis'
...
// External type placeholders (these should be properly imported from their respective modules)
export type AnalyticsConfig = any // Should be imported from analytics module
export type PinoParams = any // Should be imported from pino
export type LIT_NETWORKS_KEYS = any // Should be imported from lit protocol
export type IntentExecutionTypeKeys = readonly string[] // Should be imported from constants
export type FeeAlgorithm = 'linear' | 'quadratic' // Already defined below
export type ConfigRegex = any // Should be imported from config regex constants
export type Strategy = any // Should be imported from strategy types
...
// FeeAlgorithm type is defined above
