...
import { QUEUES, EcoLogMessage } from '@libs/shared'

// TODO: This service should be moved to domain library
// import { RetryInfeasableIntentsService } from '../../../../domain/src'
...
export class IntervalProcessor extends WorkerHost {
  ...
  constructor(private readonly retryInfeasableIntentsService: any) { // RetryInfeasableIntentsService
    super()
  }
