export const HyperlaneMailboxAbi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'hook', type: 'address' }],
    name: 'DefaultHookSet',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'bytes32', name: 'sender', type: 'bytes32' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IPostDispatchHook', name: 'hook', type: 'address' },
    ],
    name: 'dispatch',
...
export const MessageRecipientAbi = [
  {
    inputs: [
