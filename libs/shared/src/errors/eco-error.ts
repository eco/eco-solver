...
// Inline interface to avoid circular dependency - TODO: use @libs/contracts when build pipeline is fixed
...
// Type definitions that are referenced in the file
type Network = string | number
type ProofType = string
type AwsCredential = any

export class EcoError extends Error implements LoggingError {
  // Alchemy Service
  ...
  static _logError(
    ...
    srcLogger.error(logMessage, logStack && error.stack)
  }
