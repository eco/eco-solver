...
import { serializeWithBigInt, deserializeWithBigInt } from './serialize'

// TODO: This creates a circular dependency - we need to move EcoConfigService to a more foundational location
// For now, we'll define a minimal interface to break the circular dependency
interface EcoConfigService {
  getCache(): { ttl: number }
}
