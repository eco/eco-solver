export const ecoArbiterAbi = [
  {
    ...
    inputs: [
      ...
      { name: 'claimProofOracle', type: 'address', internalType: 'address' },
      {
  ...
  },
  {
    ...
    inputs: [],
    outputs: [{ name: '', type: 'address', internalType: 'contract IClaimHashOracle' }],
  ...
  },
  {
    ...
    name: 'EXECUTOR',
    inputs: [],
    outputs: [{ name: '', type: 'address', internalType: 'contract IIntentExecutor' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'claimProofSender', type: 'address', internalType: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'preClaimGasStipend', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [{ name: 'claimHash', type: 'bytes32', internalType: 'bytes32' }],
    stateMutability: 'nonpayable',
  },
