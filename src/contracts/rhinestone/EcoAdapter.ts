        ...
        components: [
          { name: 'claimHash', type: 'bytes32', internalType: 'bytes32' },
          {
            ...
            components: [
              ...
              { name: 'fillDeadline', type: 'uint256', internalType: 'uint256' },
              {
              ...
              { name: 'tokenOut', type: 'uint256[2][]', internalType: 'uint256[2][]' },
              {
                name: 'preClaimOps',
                type: 'tuple',
          ...
          },
          {
            ...
            components: [
              { name: 'notarizedClaimSig', type: 'bytes', internalType: 'bytes' },
              {
                name: 'preClaimSig',
                type: 'bytes',
                internalType: 'bytes',
          ...
          { name: 'elementIndex', type: 'uint256', internalType: 'uint256' },
          {
            name: 'otherElements',
            type: 'bytes32[]',
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: 'rewardHash', type: 'bytes32', internalType: 'bytes32' },
          {
    ...
    inputs: [
      ...
      { name: 'targetSig', type: 'bytes', internalType: 'bytes' },
      {
        ...
        components: [
          ...
          { name: 'otherElements', type: 'bytes32[]', internalType: 'bytes32[]' },
          {
            name: 'elementOffset',
            type: 'uint256',
            internalType: 'uint256',
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'notarizedChainId', type: 'uint256', internalType: 'uint256' },
        ],
      },
    ],
    outputs: [{ name: '', type: 'bytes4', internalType: 'bytes4' }],
