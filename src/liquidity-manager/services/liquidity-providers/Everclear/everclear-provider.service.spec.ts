...
describe('EverclearProviderService', () => {
  ...
  describe('checkIntentStatus', () => {
    ...
    it("should return 'pending' when intent is not found by txHash", async () => {
      ;(fetch as jest.Mock).mockResolvedValue({
        ok: true,
    ...
    it("should return 'pending' for a PENDING intent", async () => {
      ;(fetch as jest.Mock).mockResolvedValue({
        ok: true,
        json: () =>
          Promise.resolve([
    ...
    it("should return 'complete' for FILLED status", async () => {
      ;(fetch as jest.Mock).mockResolvedValue({
        ok: true,
        json: () =>
          Promise.resolve([
    ...
    it("should return 'failed' for CANCELLED status", async () => {
      ;(fetch as jest.Mock).mockResolvedValue({
        ok: true,
        json: () =>
          Promise.resolve([
