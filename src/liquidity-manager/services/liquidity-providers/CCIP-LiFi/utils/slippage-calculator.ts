import { CCIPLiFiStrategyContext } from '@/liquidity-manager/types/types'

/**
 * Calculates the total slippage for a CCIPLiFi route
 * @param context The route context containing all steps
 * @returns Total slippage percentage (0-1)
 */
export function calculateTotalSlippage(context: CCIPLiFiStrategyContext): number {
