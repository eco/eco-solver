...
describe('Decoder', () => {
  describe('decodeAdapterClaim', () => {
    it('should decode claim calldata with optimized format (eco_permit2_handleClaim_optimized)', () => {
      ...
      expect(order.sponsor).toBe('0x5eeb0df30c63390735645A0788A373550ebD5707');
      expect(order.recipient).toBe('0x5eeb0df30c63390735645A0788A373550ebD5707');
      ...
      expect(tokenInAmount).toBe(83739n);
