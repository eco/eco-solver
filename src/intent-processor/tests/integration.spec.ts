...
describe('Intent Processor - Integration Tests', () => {
  ...
  beforeEach(async () => {
    ...
    ecoConfigService = createMock<EcoConfigService>({
      ...
      getEth: jest
        .fn()
        .mockReturnValue({ claimant: '0x3333333333333333333333333333333333333333' as Hex }),
    })
    ...
    const mockWithdrawals = [
      {
        intent: {
          ...
          inbox: '0x2222222222222222222222222222222222222222' as Hex,
          rewardTokens: [
            { token: '0x3333333333333333333333333333333333333333' as Hex, amount: '1000' },
          ],
          routeTokens: [
            { token: '0x4444444444444444444444444444444444444444' as Hex, amount: '2000' },
          ],
          calls: [
            {
      ...
      },
      {
        intent: {
          ...
          inbox: '0x2222222222222222222222222222222222222222' as Hex,
          rewardTokens: [
            { token: '0x3333333333333333333333333333333333333333' as Hex, amount: '3000' },
          ],
          routeTokens: [
            { token: '0x4444444444444444444444444444444444444444' as Hex, amount: '4000' },
          ],
          calls: [
            {
              target: '0x5555555555555555555555555555555555555555' as Hex,
      ...
      },
      {
        intent: {
          ...
          inbox: '0x2222222222222222222222222222222222222222' as Hex,
          rewardTokens: [
            { token: '0x3333333333333333333333333333333333333333' as Hex, amount: '5000' },
          ],
          routeTokens: [
            { token: '0x4444444444444444444444444444444444444444' as Hex, amount: '6000' },
          ],
          calls: [
            {
              target: '0x5555555555555555555555555555555555555555' as Hex,
  ...
  describe('Withdrawal Workflow', () => {
    ...
    it('should handle indexer errors during withdrawal processing', async () => {
      ...
      indexerService.getNextBatchWithdrawals = jest
        .fn()
        .mockRejectedValue(new Error('Indexer failure'))
  ...
  describe('Send Batch Workflow', () => {
    ...
    it('should handle large batches by chunking them properly', async () => {
      ...
      mockIntentProcessorQueue.addExecuteSendBatchJobs = jest
        .fn()
        .mockImplementation(async (jobsData) => {
      ...
      const prover1Jobs = createdJobs.filter((job) =>
        job.proves.some(
          (prove: any) => prove.prover === '0x0000000000000000000000000000000000000001',
        ),
      )

      const prover2Jobs = createdJobs.filter((job) =>
        job.proves.some(
          (prove: any) => prove.prover === '0x0000000000000000000000000000000000000002',
        ),
      )
