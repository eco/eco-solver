...
describe('EcoTester', () => {
  ...
  it('should create instance of object under test and return it', async () => {
    ...
    const objUnderTest = await EcoTester
      .setupTestFor(SimpleClass)
      .init<SimpleClass>()
  ...
  it('should support having more than one test class', async () => {
    ...
    const [testClass, anotherTestClass] = await EcoTester
  ...
  it('should support multiple test classes with ref tuple', async () => {
    const objectsUnderTest = [undefined as unknown as SimpleClass, undefined as unknown as AnotherSimpleClass]
  ...
  it('should create instance of object with a dependency', async () => {
    ...
    const $ = EcoTester
      .setupTestFor(ClassWithDependency)
  ...
  it.skip('should support building a more complex test object', async () => {
    ...
    const $ = EcoTester
      .setupTestFor([ClassWithAllTheThings, ClassWithConfig])
      .withMocks(ClassWithDependency)
      .withProviders(SimpleClass)
      .customMockFor(AnotherSimpleClass).with({ doThing: jest.fn().mockReturnValue('custom') })
    ...
    const [
      ...
      classWithConfig,
    ] = await $.initMany() as [ClassWithAllTheThings, ClassWithConfig]
