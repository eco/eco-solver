...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@eco/infrastructure-external-apis$':
      '<rootDir>/../libs/infrastructure/external-apis/src/index.ts',
    '^@eco/infrastructure-event-bridge$':
      '<rootDir>/../libs/infrastructure/event-bridge/src/index.ts',
